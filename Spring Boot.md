...
1. @ServletComponentScan 基于Servlet3.0注解
   1. @WebServlet(name = "userServlet",urlPatterns = "/test/customs")
   2. @WebFilter(urlPatterns = "/*",filterName = "TestFilter")
   3. @WebListener

2. 基于springboot ，由于SpringBoot默认是以jar包的方式启动嵌入式的Servlet容器来启动SpringBoot的web应用，没有web.xml文件。
